...
const EarthMaterial: React.FC<EarthMaterialProps> = ({ sunDirection = defaultSunDirection }) => {
  ...
  const material = useMemo(() => {
    const uniforms: {
      ...
      cloudsTexture: THREE.IUniform<THREE.Texture>;
  ...
  }, [map, nightMap, cloudMap, sunDirection]);
